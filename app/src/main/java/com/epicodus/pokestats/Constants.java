...
public class Constants {
    ...
    public static final String GETUSER_URL = "http://pokestats.ngrok.io/getuserinfo/";
    public static final String GETPOKEMON_URL = "http://pokestats.ngrok.io/getpokemon/";
